    ...
    addImgToCanvasByUrl: function (url) {
        ...
        var imgDiv = $(
            '<div class="dragMe" style="border: 2px dashed gray; position:absolute; left:200px; top:200px; min-width:160px; min-height:100px; cursor:move;">' +
                '<div style="position:absolute; right:5px; top:3px;">' +
                '<button draw="1" style="margin: 0px 0px; background: #ddd; padding: 5px; margin-top: 3px; color: #000;" class="addToCanvasBtn btn btn-default">Draw to canvas</button> ' +
                '<button style="margin: 0px 0px; background: #ddd; padding: 5px; margin-top: 3px; color: #000;" class="xCanvasBtn btn btn-default">x</button>' +
                "</div>" +
